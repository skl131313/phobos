...
*/
export module std.range.primitives;
...
+/
private export void doPut(R, E)(ref R r, auto ref E e)
{
 ...
 */
@property bool empty(T)(in T[] a) @safe pure nothrow @nogc export
{
    return !a.length;
}
...
/// ditto
@property dchar front(T)(T[] a) @safe pure export if (isNarrowString!(T[]))
{
...
@property dchar back(T)(T[] a) @safe pure export if (isNarrowString!(T[]))
{
